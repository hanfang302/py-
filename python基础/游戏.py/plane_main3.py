...
class PlaneGame(object):
    ...
    def __create_sprites(self):
        ...
        # 背景精灵组
        bg1 = Backgroup('/home/hanfang/桌面/python基础/游戏.py/images/background1.png')
        bg2 = Backgroup('/home/hanfang/桌面/python基础/游戏.py/images/background1.png')
        bg2.rect.left = bg1.rect.width
