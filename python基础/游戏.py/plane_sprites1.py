...
class Hero(GameSprite):
    ...
    def __init__(self):
        super().__init__('/home/hanfang/桌面/python基础/游戏.py/images/me1.png',0)
...
class Bullet(GameSprite):
    ...
    def __init__(self):
        ...
        # 调用父类方法
        super().__init__('/home/hanfang/桌面/python基础/游戏.py/images/bullet2.png',-2)
